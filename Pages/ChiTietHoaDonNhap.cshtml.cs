...
using SuppliesManagement.Models.ViewModels; // Adjust according to your project structure
...
{
    public class ChiTietHoaDonNhapModel : PageModel // Make sure this matches
    {
        private readonly SuppliesManagementDBContext dBContext;

        public ChiTietHoaDonNhapModel(SuppliesManagementDBContext dbContext)
        {
            dBContext = dbContext;
        }
        ...
        public async Task<IActionResult> OnGetAsync(Guid id)
        {
            ...
            var hangHoas = await dBContext.NhapKhos
                ...
                .Select(n => new HangHoaViewModel
                {
                    ...
                    DonViTinh = n.HangHoa.DonViTinh.Name,
        ...
        public async Task<IActionResult> OnPostExportAsync(Guid id)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells["D7"].Value = hoaDon.KhoHang.TenKho;
                ...
                for (int i = 0; i < hangHoas.Count; i++)
                {
                    ...
                    worksheet.Cells[startRow + i, 3].Value = item.HangHoa.TenHangHoa;
                    worksheet.Cells[startRow + i, 5].Value = item.HangHoa.DonViTinhID;
                    worksheet.Cells[startRow + i, 6].Value = item.HangHoa.SoLuong;
                    worksheet.Cells[startRow + i, 7].Value = item.HangHoa.SoLuong;
                    worksheet.Cells[startRow + i, 8].Value = item.HangHoa.DonGiaTruocThue;
                    worksheet.Cells[startRow + i, 9].Value = item.HangHoa.TongGiaTruocThue;
