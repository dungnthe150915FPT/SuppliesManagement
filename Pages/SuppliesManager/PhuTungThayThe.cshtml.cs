...
namespace SuppliesManagement.Pages.SuppliesManager
{
    public class PhuTungThayTheModel : PageModel
    {
        ...
        public IActionResult OnPostExport(int year)
        {
            ...
            var worksheet = package.Workbook.Worksheets.Add("Phụ Tùng Thay Thế năm " + year);
            ...
            worksheet.Cells["B6"].Value = "Tên PTTT";
            worksheet.Cells["C6"].Value = "Mã PTTT";
            ...
            worksheet.Cells["F6:G6"].Value = "Ghi tăng PTTT";
            ...
            worksheet.Cells["H6:J6"].Value = "Ghi giảm PTTT";
